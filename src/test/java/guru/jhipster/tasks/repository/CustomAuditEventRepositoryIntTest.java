package guru.jhipster.tasks.repository;

import guru.jhipster.tasks.TasksApp;
import guru.jhipster.tasks.config.Constants;
import guru.jhipster.tasks.config.audit.AuditEventConverter;
import guru.jhipster.tasks.domain.PersistentAuditEvent;
...
import static guru.jhipster.tasks.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
